...
if d1.button("✅ موافقة"): st.success("تم تسجيل القرار: موافقة")
if d2.button("📄 طلب مستندات إضافية"): st.info("تم تسجيل القرار: طلب مستندات")
if d3.button("❌ رفض"): st.error("تم تسجيل القرار: رفض")
